...
public interface IAppOpsCallback extends android.os.IInterface
{
  ...
  {
    @Override public void opChanged(int op, int uid, java.lang.String packageName) throws android.os.RemoteException
    {
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements com.android.internal.app.IAppOpsCallback
  {
      ...
      @Override public void opChanged(int op, int uid, java.lang.String packageName) throws android.os.RemoteException
      {
        ...
        try {
          ...
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().opChanged(op, uid, packageName);
            return;
          }
        }
        finally {
    ...
    public static boolean setDefaultImpl(com.android.internal.app.IAppOpsCallback impl) {
    ...
    public static com.android.internal.app.IAppOpsCallback getDefaultImpl() {
      return Stub.Proxy.sDefaultImpl;
    }
  }
  public void opChanged(int op, int uid, java.lang.String packageName) throws android.os.RemoteException;
}
