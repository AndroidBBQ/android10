...
{
  /** Default implementation for IAuthenticateServerCallback. */
  ...
  public static abstract class Stub extends android.os.Binder implements com.android.internal.telephony.euicc.IAuthenticateServerCallback
  {
    ...
    /**
     * Cast an IBinder object into an com.android.internal.telephony.euicc.IAuthenticateServerCallback interface,
     * generating a proxy if needed.
     */
    public static com.android.internal.telephony.euicc.IAuthenticateServerCallback asInterface(android.os.IBinder obj)
    {
      if ((obj==null)) {
        return null;
      }
      android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
      if (((iin!=null)&&(iin instanceof com.android.internal.telephony.euicc.IAuthenticateServerCallback))) {
        return ((com.android.internal.telephony.euicc.IAuthenticateServerCallback)iin);
      }
      return new com.android.internal.telephony.euicc.IAuthenticateServerCallback.Stub.Proxy(obj);
    }
    ...
    public static boolean setDefaultImpl(com.android.internal.telephony.euicc.IAuthenticateServerCallback impl) {
    ...
    public static com.android.internal.telephony.euicc.IAuthenticateServerCallback getDefaultImpl() {
