...
{
  /** Default implementation for IGetEuiccProfileInfoListCallback. */
  public static class Default implements android.service.euicc.IGetEuiccProfileInfoListCallback
  {
  ...
  public static abstract class Stub extends android.os.Binder implements android.service.euicc.IGetEuiccProfileInfoListCallback
  {
    ...
    private static class Proxy implements android.service.euicc.IGetEuiccProfileInfoListCallback
    {
      ...
      public static android.service.euicc.IGetEuiccProfileInfoListCallback sDefaultImpl;
    }
    static final int TRANSACTION_onComplete = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
    public static boolean setDefaultImpl(android.service.euicc.IGetEuiccProfileInfoListCallback impl) {
    ...
    public static android.service.euicc.IGetEuiccProfileInfoListCallback getDefaultImpl() {
      return Stub.Proxy.sDefaultImpl;
    }
  }
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="/Volumes/1tdisk/Android10/android-10.0.0_r41/frameworks/base/core/java/android/service/euicc/IGetEuiccProfileInfoListCallback.aidl:23:1:23:25")
