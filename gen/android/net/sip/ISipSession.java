...
{
  /** Default implementation for ISipSession. */
  public static class Default implements android.net.sip.ISipSession
  {
    /**
  ...
  public static abstract class Stub extends android.os.Binder implements android.net.sip.ISipSession
  {
    ...
    private static class Proxy implements android.net.sip.ISipSession
    {
      ...
      @Override public java.lang.String getLocalIp() throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_getLocalIp, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getLocalIp();
          }
      ...
      @Override public android.net.sip.SipProfile getLocalProfile() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getLocalProfile, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getLocalProfile();
          }
          _reply.readException();
          if ((0!=_reply.readInt())) {
      ...
      @Override public android.net.sip.SipProfile getPeerProfile() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getPeerProfile, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getPeerProfile();
          }
          _reply.readException();
          if ((0!=_reply.readInt())) {
            _result = android.net.sip.SipProfile.CREATOR.createFromParcel(_reply);
      ...
      @Override public void register(int duration) throws android.os.RemoteException
      {
        ...
        try {
          ...
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().register(duration);
            return;
          }
          _reply.readException();
        }
      ...
      @Override public void makeCall(android.net.sip.SipProfile callee, java.lang.String sessionDescription, int timeout) throws android.os.RemoteException
      {
        ...
        try {
          ...
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().makeCall(callee, sessionDescription, timeout);
            return;
          }
          _reply.readException();
        }
      ...
      @Override public void answerCall(java.lang.String sessionDescription, int timeout) throws android.os.RemoteException
      {
        ...
        try {
          ...
          _data.writeString(sessionDescription);
          _data.writeInt(timeout);
          boolean _status = mRemote.transact(Stub.TRANSACTION_answerCall, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().answerCall(sessionDescription, timeout);
            return;
          }
          _reply.readException();
        }
      ...
      @Override public void changeCall(java.lang.String sessionDescription, int timeout) throws android.os.RemoteException
      {
        ...
        try {
          ...
          _data.writeString(sessionDescription);
          _data.writeInt(timeout);
          boolean _status = mRemote.transact(Stub.TRANSACTION_changeCall, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().changeCall(sessionDescription, timeout);
            return;
          }
          _reply.readException();
        }
      ...
      public static android.net.sip.ISipSession sDefaultImpl;
    }
    ...
    public static boolean setDefaultImpl(android.net.sip.ISipSession impl) {
    ...
    public static android.net.sip.ISipSession getDefaultImpl() {
