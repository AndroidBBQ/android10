...
{
  /** Default implementation for IPrintDocumentAdapterObserver. */
  ...
  public static abstract class Stub extends android.os.Binder implements android.print.IPrintDocumentAdapterObserver
  {
    ...
    private static class Proxy implements android.print.IPrintDocumentAdapterObserver
    {
      ...
      public static android.print.IPrintDocumentAdapterObserver sDefaultImpl;
    }
    static final int TRANSACTION_onDestroy = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
    public static boolean setDefaultImpl(android.print.IPrintDocumentAdapterObserver impl) {
    ...
    public static android.print.IPrintDocumentAdapterObserver getDefaultImpl() {
