...
{
  /** Default implementation for ICarMediaSourceListener. */
  public static class Default implements android.car.media.ICarMediaSourceListener
  {
  ...
  public static abstract class Stub extends android.os.Binder implements android.car.media.ICarMediaSourceListener
  {
    ...
    private static class Proxy implements android.car.media.ICarMediaSourceListener
    {
      ...
      @Override public void onMediaSourceChanged(android.content.ComponentName newSource) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_onMediaSourceChanged, _data, null, android.os.IBinder.FLAG_ONEWAY);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().onMediaSourceChanged(newSource);
            return;
          }
        }
        finally {
      ...
      public static android.car.media.ICarMediaSourceListener sDefaultImpl;
    }
    static final int TRANSACTION_onMediaSourceChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
    public static boolean setDefaultImpl(android.car.media.ICarMediaSourceListener impl) {
    ...
    public static android.car.media.ICarMediaSourceListener getDefaultImpl() {
