...
{
  /** Default implementation for ICarConnectionListener. */
  public static class Default implements android.car.ICarConnectionListener
  {
  ...
  public static abstract class Stub extends android.os.Binder implements android.car.ICarConnectionListener
  {
    ...
    private static class Proxy implements android.car.ICarConnectionListener
    {
      ...
      public static android.car.ICarConnectionListener sDefaultImpl;
    }
    ...
    public static boolean setDefaultImpl(android.car.ICarConnectionListener impl) {
    ...
    public static android.car.ICarConnectionListener getDefaultImpl() {
