...
{
  /** Default implementation for ICarSensorEventListener. */
  public static class Default implements android.car.hardware.ICarSensorEventListener
  {
  ...
  public static abstract class Stub extends android.os.Binder implements android.car.hardware.ICarSensorEventListener
  {
    ...
    private static class Proxy implements android.car.hardware.ICarSensorEventListener
    {
      ...
      @Override public void onSensorChanged(java.util.List<android.car.hardware.CarSensorEvent> events) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_onSensorChanged, _data, null, android.os.IBinder.FLAG_ONEWAY);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().onSensorChanged(events);
            return;
          }
        }
        finally {
      ...
      public static android.car.hardware.ICarSensorEventListener sDefaultImpl;
    }
    static final int TRANSACTION_onSensorChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
    public static boolean setDefaultImpl(android.car.hardware.ICarSensorEventListener impl) {
    ...
    public static android.car.hardware.ICarSensorEventListener getDefaultImpl() {
