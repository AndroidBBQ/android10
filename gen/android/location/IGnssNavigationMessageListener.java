...
{
  /** Default implementation for IGnssNavigationMessageListener. */
    ...
    private static class Proxy implements android.location.IGnssNavigationMessageListener
    {
      ...
      @Override public void onGnssNavigationMessageReceived(android.location.GnssNavigationMessage event) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_onGnssNavigationMessageReceived, _data, null, android.os.IBinder.FLAG_ONEWAY);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().onGnssNavigationMessageReceived(event);
            return;
          }
        }
        finally {
