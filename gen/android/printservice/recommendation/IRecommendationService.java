...
{
  /** Default implementation for IRecommendationService. */
  ...
  public static abstract class Stub extends android.os.Binder implements android.printservice.recommendation.IRecommendationService
  {
    ...
    private static class Proxy implements android.printservice.recommendation.IRecommendationService
    {
      ...
      @Override public void registerCallbacks(android.printservice.recommendation.IRecommendationServiceCallbacks callbacks) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_registerCallbacks, _data, null, android.os.IBinder.FLAG_ONEWAY);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().registerCallbacks(callbacks);
            return;
          }
        }
        finally {
    ...
    public static boolean setDefaultImpl(android.printservice.recommendation.IRecommendationService impl) {
    ...
    public static android.printservice.recommendation.IRecommendationService getDefaultImpl() {
