...
public interface ISyncAdapter extends android.os.IInterface
{
  ...
  /**
       ...
       * @param cb If called back with {@code false} accounts are not synced.
       */
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="/Volumes/1tdisk/Android10/android-10.0.0_r41/frameworks/base/core/java/android/content/ISyncAdapter.aidl:35:1:35:25")
  ...
  /**
       ...
       * @param extras SyncAdapter-specific parameters
       */
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="/Volumes/1tdisk/Android10/android-10.0.0_r41/frameworks/base/core/java/android/content/ISyncAdapter.aidl:48:1:48:25")
  ...
  /**
       ...
       * @param syncContext the ISyncContext that was passed to {@link #startSync}
       */
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="/Volumes/1tdisk/Android10/android-10.0.0_r41/frameworks/base/core/java/android/content/ISyncAdapter.aidl:57:1:57:25")
