...
{
  /** Default implementation for ITagRemovedCallback. */
  ...
  public static abstract class Stub extends android.os.Binder implements android.nfc.ITagRemovedCallback
  {
    ...
    private static class Proxy implements android.nfc.ITagRemovedCallback
    {
      ...
      @Override public void onTagRemoved() throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_onTagRemoved, _data, null, android.os.IBinder.FLAG_ONEWAY);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().onTagRemoved();
            return;
          }
        }
        finally {
    ...
    public static boolean setDefaultImpl(android.nfc.ITagRemovedCallback impl) {
    ...
    public static android.nfc.ITagRemovedCallback getDefaultImpl() {
