...
public interface IJobScheduler extends android.os.IInterface
{
  ...
  public static class Default implements android.app.job.IJobScheduler
  {
    ...
    @Override public android.content.pm.ParceledListSlice getAllPendingJobs() throws android.os.RemoteException
    {
      return null;
    }
    ...
    @Override public java.util.List<android.app.job.JobInfo> getStartedJobs() throws android.os.RemoteException
    {
      return null;
    }
    @Override public android.content.pm.ParceledListSlice getAllJobSnapshots() throws android.os.RemoteException
    {
      return null;
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements android.app.job.IJobScheduler
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        {
          data.enforceInterface(descriptor);
          android.content.pm.ParceledListSlice _result = this.getAllPendingJobs();
          reply.writeNoException();
          if ((_result!=null)) {
            reply.writeInt(1);
        ...
        case TRANSACTION_getStartedJobs:
        {
          data.enforceInterface(descriptor);
          java.util.List<android.app.job.JobInfo> _result = this.getStartedJobs();
          reply.writeNoException();
          reply.writeTypedList(_result);
          return true;
        }
        case TRANSACTION_getAllJobSnapshots:
        {
          data.enforceInterface(descriptor);
          android.content.pm.ParceledListSlice _result = this.getAllJobSnapshots();
          reply.writeNoException();
          if ((_result!=null)) {
            reply.writeInt(1);
            _result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
    ...
    private static class Proxy implements android.app.job.IJobScheduler
    {
      ...
      @Override public java.util.List<android.app.job.JobInfo> getStartedJobs() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getStartedJobs, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getStartedJobs();
          }
          _reply.readException();
      ...
      @Override public android.content.pm.ParceledListSlice getAllJobSnapshots() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getAllJobSnapshots, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getAllJobSnapshots();
          }
          _reply.readException();
          if ((0!=_reply.readInt())) {
            _result = android.content.pm.ParceledListSlice.CREATOR.createFromParcel(_reply);
    ...
    static final int TRANSACTION_getStartedJobs = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
    static final int TRANSACTION_getAllJobSnapshots = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
