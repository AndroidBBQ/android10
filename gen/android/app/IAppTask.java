...
public interface IAppTask extends android.os.IInterface
{
  ...
  public static class Default implements android.app.IAppTask
  {
    ...
    @Override public void moveToFront(android.app.IApplicationThread appThread, java.lang.String callingPackage) throws android.os.RemoteException
    {
    }
    ...
    private static class Proxy implements android.app.IAppTask
    {
      ...
      @Override public void moveToFront(android.app.IApplicationThread appThread, java.lang.String callingPackage) throws android.os.RemoteException
      {
        ...
        try {
          ...
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().moveToFront(appThread, callingPackage);
            return;
          }
          _reply.readException();
        }
  ...
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="/Volumes/1tdisk/Android10/android-10.0.0_r41/frameworks/base/core/java/android/app/IAppTask.aidl:27:1:27:25")
  public android.app.ActivityManager.RecentTaskInfo getTaskInfo() throws android.os.RemoteException;
  public void moveToFront(android.app.IApplicationThread appThread, java.lang.String callingPackage) throws android.os.RemoteException;
