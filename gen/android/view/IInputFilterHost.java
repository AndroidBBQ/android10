...
{
  /** Default implementation for IInputFilterHost. */
  ...
  public static abstract class Stub extends android.os.Binder implements android.view.IInputFilterHost
  {
    ...
    private static class Proxy implements android.view.IInputFilterHost
    {
      ...
      @Override public void sendInputEvent(android.view.InputEvent event, int policyFlags) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_sendInputEvent, _data, null, android.os.IBinder.FLAG_ONEWAY);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().sendInputEvent(event, policyFlags);
            return;
          }
        }
        finally {
    ...
    public static boolean setDefaultImpl(android.view.IInputFilterHost impl) {
    ...
    public static android.view.IInputFilterHost getDefaultImpl() {
