...
{
  /** Default implementation for IMediaResourceMonitor. */
  ...
  public static abstract class Stub extends android.os.Binder implements android.media.IMediaResourceMonitor
  {
    ...
    private static class Proxy implements android.media.IMediaResourceMonitor
    {
      ...
      @Override public void notifyResourceGranted(int pid, int type) throws android.os.RemoteException
      {
        ...
        try {
          ...
          _data.writeInt(pid);
          _data.writeInt(type);
          boolean _status = mRemote.transact(Stub.TRANSACTION_notifyResourceGranted, _data, null, android.os.IBinder.FLAG_ONEWAY);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().notifyResourceGranted(pid, type);
            return;
          }
        }
        finally {
    ...
    public static boolean setDefaultImpl(android.media.IMediaResourceMonitor impl) {
    ...
    public static android.media.IMediaResourceMonitor getDefaultImpl() {
