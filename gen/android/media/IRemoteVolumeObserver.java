...
{
  /** Default implementation for IRemoteVolumeObserver. */
  public static class Default implements android.media.IRemoteVolumeObserver
  {
  ...
  public static abstract class Stub extends android.os.Binder implements android.media.IRemoteVolumeObserver
  {
    ...
    private static class Proxy implements android.media.IRemoteVolumeObserver
    {
      ...
      @Override public void dispatchRemoteVolumeUpdate(int direction, int value) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_dispatchRemoteVolumeUpdate, _data, null, android.os.IBinder.FLAG_ONEWAY);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().dispatchRemoteVolumeUpdate(direction, value);
            return;
          }
        }
        finally {
      ...
      public static android.media.IRemoteVolumeObserver sDefaultImpl;
    }
    static final int TRANSACTION_dispatchRemoteVolumeUpdate = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
    public static boolean setDefaultImpl(android.media.IRemoteVolumeObserver impl) {
    ...
    public static android.media.IRemoteVolumeObserver getDefaultImpl() {
