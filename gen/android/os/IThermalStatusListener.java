...
{
  /** Default implementation for IThermalStatusListener. */
  public static class Default implements android.os.IThermalStatusListener
  {
    /**
         ...
         */
    @Override public void onStatusChange(int status) throws android.os.RemoteException
    {
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements android.os.IThermalStatusListener
  {
    ...
    /**
     * Cast an IBinder object into an android.os.IThermalStatusListener interface,
     * generating a proxy if needed.
     */
    public static android.os.IThermalStatusListener asInterface(android.os.IBinder obj)
    {
      if ((obj==null)) {
        return null;
      }
      android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
      if (((iin!=null)&&(iin instanceof android.os.IThermalStatusListener))) {
        return ((android.os.IThermalStatusListener)iin);
      }
      return new android.os.IThermalStatusListener.Stub.Proxy(obj);
    }
      ...
      @Override public void onStatusChange(int status) throws android.os.RemoteException
      {
        ...
        try {
          ...
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().onStatusChange(status);
            return;
          }
        }
        finally {
    ...
    public static boolean setDefaultImpl(android.os.IThermalStatusListener impl) {
    ...
    public static android.os.IThermalStatusListener getDefaultImpl() {
  ...
  /**
       ...
       * @param status defined in {@link android.os.Temperature#ThrottlingStatus}.
       */
  public void onStatusChange(int status) throws android.os.RemoteException;
}
